...
본 디렉토리는 프로젝트의 모든 문서를 체계적으로 정리한 것입니다. 프로젝트의 구조, 설계 원칙, 개발 과정에서의 고민과 결정 사항들을 기록하여 참고할 수 있도록 구성했습니다.
...
디자인 시스템, 브랜드 정체성, UI/UX 가이드입니다. 프로젝트를 진행하면서 고려한 디자인 결정 사항들을 정리했습니다.
...
기능 구현, 최적화, 코드 분석 문서입니다. 프로젝트 개발 과정에서 구현한 기능들과 고려한 사항들을 정리했습니다.
...
에러 해결, 원인 분석, 개발 히스토리입니다. 프로젝트 개발 과정에서 발생한 문제들과 해결 방법을 정리했습니다.
...
### 시작하기
- [프로젝트 개요](../README.md)
- [프로젝트 개요 상세](./PROJECT-OVERVIEW.md)
